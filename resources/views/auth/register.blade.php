    ...
    <div class="flex min-h-screen">
        ...
        <div class="hidden lg:flex lg:w-1/2 register-bg bg-cover bg-center relative">
            ...
            <div class="relative z-10 flex flex-col justify-end p-12 text-white">
                ...
                <h1 class="font-display text-5xl font-bold mb-4 leading-tight">Bergabung<br>bersama <span class="text-green-300">DhoZ-Bakes</span></h1>
                <p class="text-lg text-green-100 max-w-md">Buat akun karyawan untuk mulai mengelola kasir dan pesanan pelanggan.</p>
            </div>
        </div>
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12">
            <div class="w-full max-w-md">
                ...
                <p class="text-gray-500 mb-8">Daftar untuk mulai menggunakan POS</p>
                ...
                <div class="grid grid-cols-2 bg-gray-100 rounded-xl p-1 mb-8">
                    <span class="py-2.5 rounded-lg text-sm font-semibold text-center bg-brand text-white shadow-sm">Karyawan</span>
                    <a href="{{ route('customer.register') }}" class="py-2.5 rounded-lg text-sm font-semibold text-center text-gray-500 hover:text-gray-700 transition">Pelanggan</a>
                </div>
                ...
                <div class="text-center mt-8 text-sm text-gray-500">
                    Sudah punya akun? <a href="{{ route('login') }}" class="text-brand font-semibold hover:underline">Masuk</a>
                </div>
            </div>
        </div>
    </div>
