    ...
    <div class="flex min-h-screen">
        ...
        <div class="hidden lg:flex lg:w-1/2 login-bg bg-cover bg-center relative">
            ...
            <div class="relative z-10 flex flex-col justify-end p-12 text-white">
                ...
                <p class="text-lg text-green-100 max-w-md">Masuk untuk mulai pesan kopi & kue favorit Anda.</p>
            </div>
        </div>
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12">
            <div class="w-full max-w-md">
                ...
                <p class="text-gray-500 mb-8">Masuk sebagai pelanggan</p>
                ...
                <div class="grid grid-cols-2 bg-gray-100 rounded-xl p-1 mb-8">
                    <a href="{{ route('login') }}" class="py-2.5 rounded-lg text-sm font-semibold text-center text-gray-500 hover:text-gray-700 transition">Karyawan</a>
                ...
                <div class="text-center mt-8 text-sm text-gray-500">
                    Belum punya akun? <a href="{{ route('customer.register') }}" class="text-brand font-semibold hover:underline">Daftar di sini</a>
                </div>
            </div>
        </div>
    </div>
