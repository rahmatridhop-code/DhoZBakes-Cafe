@extends('layouts.app')
@section('title', 'Tambah Meja - DhoZ-Bakes')
...
<div class="row">
    <div class="col-lg-6">
        <div class="card">
            <div class="card-header"><i class="bi bi-plus-circle"></i> Form Tambah Meja</div>
            <div class="card-body">
                @if($errors->any())
                ...
                <form method="POST" action="{{ route('admin.tables.store') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" class="form-control" value="{{ old('name') }}" required placeholder="Contoh: Meja 1">
                    </div>
                    <div class="mb-3">
