@extends('layouts.app')
@section('title', 'Edit Kategori - DhoZ-Bakes')
...
<div class="row">
    <div class="col-lg-6">
        <div class="card">
            <div class="card-header"><i class="bi bi-pencil"></i> Form Edit Kategori</div>
            <div class="card-body">
                @if($errors->any())
                ...
                <form method="POST" action="{{ route('admin.categories.update', $category) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="icon" class="form-control" value="{{ old('icon', $category->icon) }}" maxlength="10">
                    </div>
                    <div class="mb-3">
